...
3) Access the `workbench` named `codegen-manual-testing-existing-1-notebook`
...
5) In the terminal, run `cd codegen-manual-testing-existing-1` to navigate to your sample app's directory
